                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-12">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
                            <h1 class="mb-4 text-center">DRINK JOURNAL</h1>
                            <p class="apaan">Ingatlah, Minum air adalah langkah kecil yang membuat perubahan besar dalam kesehatan sahabat. 
                                Drink Journal akan menemani sahabat setiap harinya guna menjaga keseimbangan cairan tubuh hingga menjadi 
                                kebiasaan sahabat.</p>
                                ...
                                <b>Mari mulai kebiasaan minum yang teratur<br>bersama Drink Journal</b>
